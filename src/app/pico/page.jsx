  ...
  return (
    <div className="min-h-screen bg-[#111112] text-white selection:bg-[#ff2a85] selection:text-white font-sans overflow-x-hidden">
      ...
      <div className="fixed inset-0 pointer-events-none z-0">
        <div className="absolute top-[-10%] left-[-10%] w-[50%] h-[50%] bg-[#ff2a85] rounded-full mix-blend-screen filter blur-[120px] opacity-20 animate-pulse"></div>
        <div className="absolute bottom-[-10%] right-[-10%] w-[50%] h-[50%] bg-[#5d12ff] rounded-full mix-blend-screen filter blur-[150px] opacity-10"></div>
      </div>
      ...
      <div className="relative z-10">
        ...
        <section className="min-h-screen flex flex-col items-center justify-center px-4 md:px-20 text-center">
          ...
          >
            <h1 className="text-6xl md:text-8xl font-bold tracking-tight">
              pico<span className="text-[#ff2a85]">.</span>
            </h1>
            ...
            <div className="pt-12">
              <Link 
                href="#explore" 
                className="inline-flex items-center justify-center px-8 py-4 rounded-full bg-[#ff2a85]/10 text-[#ff2a85] border border-[#ff2a85]/30 hover:bg-[#ff2a85]/20 hover:scale-105 transition-all duration-300 font-medium"
              >
                Start Exploring
              </Link>
            </div>
        ...
        <section id="explore" className="py-32 px-4 md:px-20 flex flex-col items-center justify-center text-center">
          ...
          >
            <h2 className="text-4xl md:text-5xl font-semibold mb-8">We often brush past the little things.</h2>
            <p className="text-xl text-gray-400 leading-relaxed">
              But our days are made of pico-sized moments. A moment of doubt, a sudden burst of joy, a quiet wave of calm. pico helps you capture these micro-emotions so you can see the bigger picture of your well-being.
            </p>
          </motion.div>
        </section>
        ...
        <section className="py-24 px-4 md:px-20 max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <motion.div
              ...
              className="group relative bg-[#1c1c1e]/60 backdrop-blur-xl border border-white/5 rounded-3xl p-8 hover:border-[#ff2a85]/50 transition-colors duration-500 overflow-hidden"
            >
              <div className="absolute top-0 right-0 w-32 h-32 bg-[#ff2a85] rounded-full blur-[80px] opacity-0 group-hover:opacity-20 transition-opacity duration-500"></div>
        ...
        <section className="py-24 px-4 md:px-20 max-w-5xl mx-auto flex flex-col items-center text-center">
            ...
            >
              <div className="absolute -top-40 -left-40 w-96 h-96 bg-[#ff2a85] mix-blend-screen filter blur-[120px] opacity-20"></div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-left relative z-10">
                 ...
                 <div className="bg-[#2a1b24] border border-[#ff2a85]/20 rounded-3xl p-8 flex flex-col justify-between hover:-translate-y-2 transition-transform duration-300">
                    <div className="text-[#ff2a85] mb-4">❤️</div>
                    <div>
                      <div className="text-5xl font-bold mb-2">0</div>
                      <div className="text-white font-medium">Clean Gap</div>
                      <div className="text-[#ff2a85] text-sm">Days in control</div>
                    </div>
                 </div>
                 ...
                 <div className="bg-[#2a1b24] border border-[#ff2a85]/20 rounded-3xl p-8 flex flex-col justify-between hover:-translate-y-2 transition-transform duration-300">
                    ...
                    <div>
                      ...
                      <div className="text-[#ff2a85] text-sm">Active</div>
                    </div>
                 </div>
              </div>
            </motion.div>
        ...
        <section className="py-32 px-4 flex flex-col items-center justify-center text-center">
          ...
          >
            ...
            <Link 
              href="#" 
              className="inline-flex items-center justify-center px-10 py-5 rounded-full bg-[#ff2a85] text-white hover:bg-[#e01a6b] hover:shadow-[0_0_40px_rgba(255,42,133,0.4)] hover:scale-105 transition-all duration-300 font-semibold text-lg"
            >
              Make space for you
            </Link>
          </motion.div>
